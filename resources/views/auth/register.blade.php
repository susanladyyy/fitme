...
@section('content')
<div style="padding: 0; margin-top: 35px; font-weight: 500; margin-bottom: -30px; height: fit-content;">
    <div class="split-screen" style="display: flex; flex-direction: row">
        ...
        <div
            ...
            "
        >
            <form method="POST" action="{{ route('register') }}" style="width: 328px">
            @csrf    
                <section class="copy" style="color: black; text-align: center; margin-top: 20px;">
                    <h2 style="color: #ff6a6a">Register</h2>
                ...
                <div class="register-container">
                    ...
                    <a href="{{ route('login') }}" style="color: #ff6a6a">
